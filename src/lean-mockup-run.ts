...
export const LEAN_MOCKUP_RUN = [
  ...
  "  3. Include filters-sidebar SNIPPET (CLOSED by default — no class=\"open\").",
  "     Only add class=\"open\" when the ticket EXPLICITLY requires the filter panel open on load.",
  "     Layout — sidebar covers FULL main view under navbar, NOT table-only:",
  "     [topbar][primary-nav] then <div class=\"content-with-filters\">",
  "       [filters-sidebar]",
  "       <div class=\"page-main\">",
  "         [toolbar-top][filter-bar][optional top-summary-filters]",
  "         <div class=\"table-section\"> [table + pagination] </div>",
  "       </div>",
  "     </div>.",
  "     Sidebar overlays via position:absolute inside position:relative .content-with-filters.",
  ...
  "     DEFAULT S.pageSize = 10; rows-per-page <select> must have option 10 selected.",
